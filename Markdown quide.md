...
***Markdown*** - это простой и удобный способ написания контента для Интернета, а также идеальный способ для разработчиков создавать документацию. Он позволяет легко  структурировать и форматировать документы с помощью простой текстовой разметки, которая затем конвертируется в HTML  - и все это в текстовом редакторе.

**Markdown** прост в освоении и не заставляет использовать определенную программу. Буду знакомиться с данными языковой разметки дальше. Моё первое знакомство с ним оцениваю весьма положительно.